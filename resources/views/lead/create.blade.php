...
<body class ="bg-light">
	<form enctype="multipart/form-data" method="post" action="/lead/store">
		@csrf
		<nav class="main-header" style="margin-top:40px">
			<div class="col-lg-12">
    		    <div class="card card-primary">
            	  	<div class="card-header">
                		<h3 class="card-title p-3">Lead Create</h3>
              		</div>
                	<div class="p-4">
                		<div class="mt-3">
                			<label>Lead Name</label>
                			<input type="name" class="form-control" name="lead_name" placeholder="Enter Lead Name">
